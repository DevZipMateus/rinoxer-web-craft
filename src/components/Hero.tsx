...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-subtle pt-20">
      <div className="container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          ...
          <div className="animate-scale-in">
            <video className="w-full h-auto rounded-lg shadow-elegant" autoPlay loop muted playsInline>
